...
func attention(c *ava.Context) {
	...
	for _, entity := range allEntities {
		if entity.Category == core.CategoryGas {
			auto, err := gas(entity)
			if err != nil {
				c.Error(err)
				continue
...
// 天然气报警
func gas(entity *core.Entity) (*Automation, error) {
...
func fire(entity *core.Entity) (*Automation, error) {
...
func water(entity *core.Entity) (*Automation, error) {
...
func doNotify(title, message string, auto *Automation) {
	notifyPhoneId := core.GetNotifyPhone()
